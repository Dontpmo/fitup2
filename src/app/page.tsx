    ...
    <main className="h-[4000px]">
              ...
              {[
                ...
                <div key={i} className="single-progressbar py-3">
                  ...
                  <div className="w-full bg-gray-500 h-1">
                    <div className={`h-full bg-lick`} style={{width : `${percent}%`}}></div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="Why-choose-us relative bg-[url('/images/bg-dark.png')] bg-fixed">
        ...
        <div className="relative flex flex-col items-center pt-[80px] px-2 z-10">
          <div className="flex items-center gap-2">
            <p className="uppercase text-lick font-medium">ทำไมต้องเลือกยิมเรา</p>
          ...
          <p className="text-white py-10 text-center">
            เราเชื่อว่าการออกกำลังกายที่ดี ต้องมาพร้อมกับการดูแลที่ใส่ใจ และนี่คือสิ่งที่เทรนเนอร์ของเราทำอย่างเต็มที่ ทุกคนผ่านการฝึกอบรมและมีประสบการณ์สูง สามารถแนะนำวิธีการออกกำลังกายที่ถูกต้องและปลอดภัย พร้อมให้คำแนะนำด้านโภชนาการ และปรับโปรแกรมตามเป้าหมายของคุณ
          </p>
        </div>
        ...
        <div className="what relative numbers w-screen bg-lick px-3 py-7 grid grid-rows-2 grid-cols-2 px-10 gap-5">
         <div className="flex flex-col gap-3 justify-center items-center text-center  ">
          <p className="font-normal text-xl text-center">ประสบการณ์กว่า</p>
              <h2 className="text-5xl">12+ <span className="text-sm">ปี</span></h2>
         ...
         <div className="flex flex-col gap-3 justify-center items-center border-l-1 border-black text-">
          <p className="text-xl text-center">มีลูกค้าประจำกว่า </p>
              <h2 className="text-5xl">50+ <span className="text-sm">คน</span></h2>
              
         </div>
         <div className="flex flex-col gap-3 justify-center items-center text-center  ">
          <p className="font-normal text-xl text-center">เทรนเนอร์มีใบรับรองกว่า</p>
              <h2 className="text-5xl">14 <span className="text-sm">ใบ</span></h2>
         ...
         <div className="flex flex-col gap-3 justify-center items-center border-l-1 border-black">
          <p className="text-xl text-center">มีสถานที่ตั้งกว่า </p>
              <h2 className="text-5xl">12 <span className="text-sm">จุด</span></h2>
      ...
      <section className="our-services py-19 items-center our-services bg-radial from-goodBrown to-transparent ]">
        <div className="text ml-4">
          ...
          <h3 className="text-6xl font-bold"><span className="text-lick font-p">บริการ</span>ของเรา</h3>
          <p className="py-5 pb-15 text-md ">เรารู้ดีว่า ความต้องการและเป้าหมายของลูกค้านั้นแตกต่างกัน แต่ยิมของเรามี โปรแกรมออกกำลังกายที่ครอบคลุมทุกความต้องการ ไม่ว่าคุณจะตั้งเป้าอะไร เรามีทางเลือกที่เหมาะกับคุณ</p>
        </div>
        <div className="services grid grid-rows-3 grid-cols-1 gap-3 px-2">
          ...
          <p className="pt-4 text-center text-sm  ">เพิ่มความแข็งแรงของกล้ามเนื้อ และปรับรูปร่างให้ฟิตขึ้น</p>
          </article>
          <article className="px-8 py-11 bg-white flex flex-col items-center ">
          <img src="images/service-5.png" alt="" />
          <h2 className="uppercase mt-5">ต่อยมวย</h2>
          <p className="pt-4 text-center text-sm  ">ออกกำลังกายแบบคาร์ดิโอสูง สนุกและลดความเครียด</p>
          </article>
          <article className="px-8 py-11 bg-white flex flex-col items-center ">
          <img src="images/service-4.png" alt="" />
          <h2 className="uppercase mt-5">โยคะ</h2>
          <p className="pt-4 text-center text-sm  ">ปรับสมดุลร่างกายและจิตใจ ให้รู้สึกผ่อนคลาย</p>
          </article>
          
          <article className="px-8 py-11 bg-white flex flex-col items-center ">
          <img src="images/service-6.png" alt="" />
          <h2 className="uppercase mt-5">แอโรบิค</h2>
          <p className="pt-4 text-center text-sm  ">เบิร์นไขมัน เพิ่มความกระฉับกระเฉง และสนุกไปกับดนตรี</p>
          </article>
      ...
      <PopularPrograms/>
      <Plans/>
      <section id="form" className="bookings  py-10 bg-[url('/images/bg-dark.png')] relative bg-center bg-cover bg-fixed">
      <div className="bg-gradient-to-r from-tik to-lightTik absolute inset-0"></div>
          <div className="relative flex justify-center flex-col items-center ">
            ...
            <h2 className="text-white text-4xl    ">BOOK FOR <span className="text-lick">TRAINING</span></h2>
          </div>
          
            <div className="relative ">
              <form action="POST" className="relative mx-6 text-white">
                <input type="text" placeholder="ชื่อ" className="border-b-1 border-white py-5 mb-4 w-full focus:border-lick focus:outline-hidden transition-all duration-600 ease-out " />
                <input type="text" placeholder="นามสกุล" className="border-b-1 border-white py-5 mb-4 w-full focus:border-lick focus:outline-hidden transition-all duration-600 ease-out" />
                <input type="text" placeholder="เบอร์โทร" className="border-b-1 border-white py-5 mb-4 w-full focus:border-lick focus:outline-hidden transition-all duration-600 ease-out" />
                <input type="text" placeholder="Email" className="border-b-1 border-white py-5 mb-4 w-full focus:border-lick focus:outline-hidden transition-all duration-600 ease-out" />
                <button type="submit" className="bg-lick text-white text-bold text-xl px-8 py-4 my-5 font-kanit cursor-pointer">ลงทะเบียน</button>
              </form>
            </div>
